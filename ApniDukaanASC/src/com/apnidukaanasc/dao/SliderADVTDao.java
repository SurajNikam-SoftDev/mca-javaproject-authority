...
import com.apnidukaanasc.bean.SliderADVTBean;
...
//			System.out.println("update slideradvt set advtimage = '"+fileName+"' where rank = '"+rank+"'");
			PreparedStatement ps= con.prepareStatement("update slideradvt set advtimage = ? where rank = ?");
