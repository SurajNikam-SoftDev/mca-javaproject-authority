...
<%
	...
	session.setAttribute("advtrank", key); 
	...
	<!--========== HEADER ==========-->
        ...
        <!--========== CONTENTS ==========-->
         ...
         <div class = "container-fluid page-header text-center">
        	<b>Edit Slider ADVT</b>
        </div>
        <div class = "container-fluid form-container">
        	
        <form class = "form-body" name = "form" action = "./EditSliderADVT" method = "POST" enctype = "multipart/form-data">
            <div class="form-row">
	            <div class="form-group col-md-6">
	                <label for="inputAddress">Advertisement Rank<span style = "color:red;font-size:14px;font-weight:bolder;">*</span></label>
	                <input type="text" class="form-control" name="rank" value = "<%= key %>" readonly>
	            </div>
	            <div class="form-group col-md-6">
