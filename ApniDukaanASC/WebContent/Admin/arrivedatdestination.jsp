...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApniDukaanASC :: Arrived At Destination</title>
...
%>
    ...
    function loadXMLDoc() {
        ...
        var url = "GetParcelListByCategory?status=In-Transit&datefrom="+document.getElementById("datefrom").value+"&dateto="+document.getElementById("dateto").value;
        //alert(url);
