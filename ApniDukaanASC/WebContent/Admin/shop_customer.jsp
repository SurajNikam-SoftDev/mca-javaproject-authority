...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApniDukaanASC :: Shop & Customer Details</title>
            ...
            <div class="header__container">
                ...
                <div class="header__search">
                    ...
                    <datalist id="browsers" style = "height: 80vh;">
					  ...
					  <option value="Add New Shop_Customer">
					  <option value="Shop_Customer List">
                        ...
                        <div class="nav__items">
                            ...
                            <div class="nav__dropdown">
                                <a href="#" class="nav__link">
                                    ...
                                    <span class="nav__name">Shop_Customer</span>
                                    <i class='bx bx-chevron-down nav__icon nav__dropdown-icon'></i>
                                </a>
								<div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        <a href="Shop_CustomerList" class="nav__dropdown-item">List All</a>
