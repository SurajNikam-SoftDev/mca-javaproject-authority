...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApniDukaanASC :: Delivered</title>
...
%>
   ...
   <script>
    ...
    function loadXMLDoc() {
        ...
        var url = "GetParcelListByCategory?status=Ready to Pickup&datefrom="+document.getElementById("datefrom").value+"&dateto="+document.getElementById("dateto").value;
        //alert(url);
