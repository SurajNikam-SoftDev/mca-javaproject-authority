...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApniDukaanASC :: Staff List</title>
	...
	<!--========== HEADER ==========-->
		...
		<div class="container-fluid table-container" style= "" >
			<div class = "text-right mt-2 mb-2" >
				<a href="javascript:void(0)" onclick="location.href='AddNewStaff'" style = "font-size:12px;font-weight:bolder;border-radius:5px;padding:10px;border:1px solid #007bff;color: #007bff;text-decoration: none;">+ Add New Staff</a>
			</div>
