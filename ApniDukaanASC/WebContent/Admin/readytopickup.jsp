...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApniDukaanASC :: Ready To PickUp</title>
...
%>
    ...
    function loadXMLDoc() {
        ...
        var url = "GetParcelListByCategory?status=Out for Delivery&datefrom="+document.getElementById("datefrom").value+"&dateto="+document.getElementById("dateto").value;
        //alert(url);
