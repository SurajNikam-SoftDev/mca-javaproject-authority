...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApniDukaanASC :: New Added Product List</title>
            ...
            <div class="header__container">
                ...
                <div class="header__search">
                    ...
                    <datalist id="browsers" style = "height: 80vh;">
					  ...
					  <option value="Add New NewAddedProduct">
					  <option value="NewAddedProduct List">
    				...
    				<div class="nav__list">
                        <div class="nav__items">
                            ...
                            <div class="nav__dropdown">
								...
								<div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        <a href="NewAddedProductList" class="nav__dropdown-item">List All</a>
            ...
            <tbody>
                <tr>
                    ...
                    <td class = "text-center">
                    	<a href="javascript:void(0)" onclick="location.href='ViewNewAddedProduct'" class = "" style = "text-decoration: none;" data-toggle="tooltip" data-placement="bottom" title="View" data-toggle="tooltip" data-placement="bottom" title="View"><i class="material-icons nav__icon">visibility</i></a>
