...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApniDukaanASC :: Parcel List</title>
...
%>
    ...
    function loadXMLDoc() {
        ...
        var url = "GetParcelList?status=Approved By Seller&datefrom="+document.getElementById("datefrom").value+"&dateto="+document.getElementById("dateto").value;
       // alert(url);
