...
//		alert(document.getElementById('productcategory').value + " :: " +document.getElementById('datefrom').value + " :: " +document.getElementById('dateto').value);
        ...
        var url = "GetSPProductDetails?productcategory="+document.getElementById('productcategory').value+"&productsearch="+document.getElementById('productsearch').value+"&datefrom="+document.getElementById('datefrom').value+"&dateto="+document.getElementById('dateto').value;
//      alert(url);
