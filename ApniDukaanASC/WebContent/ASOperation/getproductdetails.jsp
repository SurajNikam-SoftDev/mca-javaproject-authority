...
%>            
              	<tr>
                    ...
                    <td class = "text-center">
                    	<a href="javascript:void(0)" class = "btn btn-success" data-toggle="tooltip" data-placement="top" title="View Product Details" onclick="location.href='ViewProduct?key=<%= product.getPid() %>'" style = "padding:0px;text-decoration: none;"><i class="material-icons p-1" style = "font-size:20px;color:white;">visibility</i></a>
	                    <a href="javascript:void(0)" class = "btn btn-danger" data-toggle="tooltip" data-placement="top" title="Product Decline" onclick="location.href='DeleteProduct?key=<%= product.getPid() %>'" style = "padding:0px;text-decoration: none;"><i class="material-icons p-1" style = "font-size:20px;color:white;">delete_forever</i></a>
                    </td>
                </tr>
<%
	}
