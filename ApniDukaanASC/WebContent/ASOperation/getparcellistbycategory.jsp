...
<%
	...
	System.out.println(status + " :: " + datefrom + " :: " + dateto);
...
%>            
              	<tr>
                    ...
                    <td class = "text-center">
                    	<a href="javascript:void(0)" class = "btn btn-success" data-toggle="tooltip" data-placement="top" title="View Parcel" onclick="location.href='ViewParcel?key=<%= parcel.getParcelid() %>'" style = "padding:0px;text-decoration: none;"><i class="material-icons p-1" style = "font-size:20px;color:white;">visibility</i></a>
                    </td>
                </tr>
<%
	}
